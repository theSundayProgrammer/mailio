...
public:
    ...
    **/
    pop3(asio::io_context& ios_,const std::string& hostname, unsigned port, std::chrono::milliseconds timeout = std::chrono::milliseconds(0));
...
public:
    ...
    **/
    pop3s(asio::io_context& ios,  const std::string& hostname, unsigned port, std::chrono::milliseconds timeout = std::chrono::milliseconds(0));
