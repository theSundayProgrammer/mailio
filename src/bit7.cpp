...
bit7::bit7(std::string::size_type line1_policy, std::string::size_type lines_policy) :
    codec(line1_policy, lines_policy)
{
}


vector<std::string> bit7::encode(const std::string& text) const
{
...
std::string bit7::decode(const vector<std::string>& text) const
{
    std::string dec_text;
